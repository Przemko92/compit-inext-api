...
class CompitParameter(Enum):
    ...
    DHW_TARGET_TEMPERATURE_2 = "DHW_TARGET_TEMPERATURE_2"
    HEATER_TARGET_TEMPERATURE = "HEATER_TARGET_TEMPERATURE"
    HEATING_ELEMENT_TARGET_TEMPERATURE = "HEATING_ELEMENT_TARGET_TEMPERATURE"
    DHW_FROM_BOILER_TARGET_TEMPERATURE = "DHW_FROM_BOILER_TARGET_TEMPERATURE"

    # Settings
    TARGET_TEMPERATURE_COMFORT = "TARGET_TEMPERATURE_COMFORT"
    TARGET_TEMPERATURE_ECO_WINTER = "TARGET_TEMPERATURE_ECO_WINTER"
    TARGET_TEMPERATURE_ECO_COOLING = "TARGET_TEMPERATURE_ECO_COOLING"
    TARGET_TEMPERATURE_OUT_OF_HOME = "TARGET_TEMPERATURE_OUT_OF_HOME"
    TARGET_TEMPERATURE_ECO = "TARGET_TEMPERATURE_ECO"
    TARGET_TEMPERATURE_HOLIDAY = "TARGET_TEMPERATURE_HOLIDAY"
    TARGET_TEMPERATURE_CONST = "TARGET_TEMPERATURE_CONST"
    HEATING_TARGET_TEMPERATURE_CONST = "HEATING_TARGET_TEMPERATURE_CONST"
    MIXER_TARGET_TEMPERATURE = "MIXER_TARGET_TEMPERATURE"
    MIXER1_TARGET_TEMPERATURE = "MIXER1_TARGET_TEMPERATURE"
    MIXER2_TARGET_TEMPERATURE = "MIXER2_TARGET_TEMPERATURE"
    BOILER_TARGET_TEMPERATURE = "BOILER_TARGET_TEMPERATURE"
    BOILER_TARGET_TEMPERATURE_CONST = "BOILER_TARGET_TEMPERATURE_CONST"

    # Ventilation
    VENTILATION_ON_OFF = "VENTILATION_ON_OFF"
